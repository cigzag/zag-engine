...
#define DARRAY_RESIZE_FACTOR 2 // Current capacity and resize by base of 2.
...
// for VSCode flags it as a unknown type. typeof() seems to
...
// darray_reserve does not set length, therefor we can't get length unless set, use this with reserve
